...
const ModalContainer = ({ children }: ModalContainerProps) => {
  ...
  return (
    <section className="bg-gradient-modal-container relative m-auto flex h-[80%] w-[80%] flex-col items-center justify-center rounded-lg shadow-xl shadow-zinc-950 md:h-[80%]">
      <div
        style={sectionStyle}
